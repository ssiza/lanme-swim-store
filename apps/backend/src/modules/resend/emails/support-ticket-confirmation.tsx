...
export const supportTicketConfirmationEmail = ({
  name,
  email,
  topic_label,
  message,
  ...
  return (
    <Html>
      <Head />
      <Preview>We received your Lanmè Swim support request</Preview>
      <Body style={main}>
        <Section style={container}>
          <Heading style={heading}>Lanmè Swim</Heading>
          <Text style={paragraph}>
            Hi {name || "there"}, we received your support request
            {email ? ` for ${email}` : ""}.
          </Text>
          {ticket_id && (
          ...
          {topic_label && (
            <Text style={paragraph}>Topic: {topic_label}</Text>
          )}
          {order_number && (
          ...
          <Text style={paragraph}>
            Our team will reply by email as soon as possible.
          </Text>
        </Section>
      </Body>
    </Html>
